...
class ClaudeCodeOAuthManagerTests(unittest.TestCase):
    def test_refresh_persists_to_plaintext_store(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch("claude_code_auth.manager.platform.system", return_value="Linux"):
            ...
            self.assertGreater(stored["expiresAt"], initial_payload["claudeAiOauth"]["expiresAt"])
